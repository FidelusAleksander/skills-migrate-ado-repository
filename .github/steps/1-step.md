...
<<<<<<< Updated upstream
    ...
    <img width="600" alt="Show all scopes link at the bottom of the token scopes view" src="https://github.com/FidelusAleksander/skills-migrate-ado-repository/blob/main/.github/images/show-all-scopes-link.png?raw=true" />
=======
